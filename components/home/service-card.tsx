...
// Changes: Made entire service card clickable by wrapping it in Link, removed separate "Learn More" link
"use client";
  ...
  return (
    ...
    >
      <Link href={service.href} className="block">
        <div className="service-card p-6 md:p-8 h-full cursor-pointer">
          <motion.div 
          ...
          <motion.div
            className="flex items-center text-text-brown hover:text-primary-green transition-colors font-medium"
            initial={{ x: 0 }}
            whileHover={{ x: 5 }}
